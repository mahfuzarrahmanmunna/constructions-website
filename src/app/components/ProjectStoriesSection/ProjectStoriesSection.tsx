...
export default function RecentProjectsSection() {
  ...
  const filteredProjects = useMemo(() => {
    ...
    return list.filter((p) => p._id !== featured?._id);
    ...
    return (
      <section className="relative overflow-hidden bg-[#ffffff] pb-16 sm:pb-24">
        <div className="max-w-7xl mx-auto px-5 md:px-8">
          <div className="h-12 w-64 bg-slate-200 rounded animate-pulse mb-10"></div>
          <div className="h-[500px] w-full bg-slate-100 rounded-3xl animate-pulse"></div>
        </div>
      </section>
    );
  }
    ...
    return (
      <section className="relative overflow-hidden bg-[#ffffff] pb-16 sm:pb-24">
        ...
        <div className="max-w-7xl mx-auto px-5 md:px-8 relative z-10">
          ...
          <h2
            className="text-3xl sm:text-4xl lg:text-[46px] font-extrabold tracking-tight leading-[1.1] mb-8"
          ...
          <div className="bg-amber-50 border-2 border-dashed border-amber-300 rounded-2xl p-12 text-center">
            ...
            <p className="text-amber-600 text-sm max-w-md mx-auto mb-6">
              Projects are saved as <strong>&quot;Draft&quot;</strong> by
              default. Go to your admin panel and change the status to{" "}
  ...
  return (
    <section className="relative overflow-hidden bg-[#ffffff] pb-16 sm:pb-24">
      ...
      <div className="max-w-7xl mx-auto px-5 md:px-8 relative z-10">
        ...
        {/* EXPLORE MORE — Only show if there are more projects */}
          ...
          <>
            <div className="flex max-w-7xl mx-auto overflow-hidden flex-col sm:flex-row sm:items-center sm:justify-between gap-4 mb-6 md:mb-8">
              ...
              <div className="flex items-center gap-3">
                ...
                <Link
                  href="/ourWorks"
                  className="hidden lg:inline-flex items-center gap-2 text-xs font-bold uppercase tracking-wider transition-colors duration-300 mr-1"
                  style={{ color: COLORS.navy }}
                  onMouseEnter={(e) =>
