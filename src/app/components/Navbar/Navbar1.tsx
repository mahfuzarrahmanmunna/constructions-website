  ...
  return (
    <div className="relative transition-all duration-500 ease-out">
      ...
      <header className="fixed top-0 left-0 z-50 w-full px-4 py-4 lg:top-2 lg:left-1/2 lg:w-[92%] lg:max-w-7xl lg:-translate-x-1/2">
        <div
          className={`flex  lg:rounded-full lg:px-8 lg:py-4 lg:border  text-[#002253] lg:border-white/20 lg:bg-white/10 lg:backdrop-blur-lg lg:shadow-lg lg:shadow-black/5 items-center justify-between transition-all duration-300 border-b border-white/20 md:bg-white/5 md:backdrop-blur-lg
          `}
        >
          {/* Logo */}
          <Link
          ...
          <nav className="hidden lg:flex items-center gap-10">
            {mainLinks.map((link) => (
              <Link
                ...
                className={`text-sm font-medium text-[#002253] hover:text-[#E55503] transition-colors duration-300 `}
              >
                {link}
              </Link>
            ))}
