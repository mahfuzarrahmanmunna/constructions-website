...
// };
  ...
  return (
    <div className="auth-shell flex min-h-screen">
      ...
      {/* Form Panel */}
      <div className="form-panel flex-1 flex items-center justify-center relative overflow-hidden">
        ...
        <div className="form-container w-full max-w-[400px] p-10 relative">
          {/* Tabs */}
          <div className="tabs flex relative mb-10 bg-[#1a1a1a] rounded-xl p-1 animate-[fadeUp_0.8s_ease-out_0.15s_forwards]">
            <button
              className={`tab flex-1 px-5 py-3 border-none bg-none font-outfit text-[0.9rem] font-medium cursor-pointer transition-colors duration-300 rounded z-2 `}
              type="button"
              role="tab"
            >
              Sign In
