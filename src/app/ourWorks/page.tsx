...
export default function OurWorksPage() {
  ...
  const filteredCases = projects.filter((c) => c.category === activeCategory);
  ...
  if (loading)
    return (
      <main className="w-full font-sans text-[#002253] bg-slate-50 min-h-screen flex items-center justify-center">
  ...
  return (
    <main className="w-full font-sans text-[#002253] bg-slate-50 min-h-screen pb-20">
      ...
      <section
        ...
        style={{ backgroundImage: "url('/background/ourworks.jpg')" }}
      >
              ...
              {filteredCases.length === 0 ? (
                <div className="w-full py-20 text-center bg-white rounded-2xl border border-slate-100 shadow-sm">
                  <p className="text-slate-500 font-medium">
                    No project cases catalogued for this category yet.
                  </p>
                </div>
              ) : (
                filteredCases.map((study, index) => {
                  ...
                  if (index === 0 || index === 4) {
                    ...
                    return (
                      ...
                      >
                        ...
                        <div
                          className={`absolute bottom-0 p-6 md:p-12 w-full md:max-w-2xl text-white z-10 transition-transform duration-300 group-hover:-translate-y-1.5 ${textLeft ? "left-0" : "right-0 text-right md:items-end md:flex md:flex-col"}`}
                        >
                          <div
                            className={`flex items-center gap-3.5 mb-4 ${textLeft ? "justify-start" : "justify-end"}`}
                          >
                          ...
                          <p
                            className={`text-slate-300 text-xs md:text-sm font-light leading-relaxed mb-6 line-clamp-2 max-w-xl ${textLeft ? "text-left" : "text-right"}`}
                          >
                            {study.description}
                          </p>
                          ...
                          <div className="w-full">
                            ...
                            <div className="bg-white/5 border border-white/10 p-5 rounded-xl flex flex-wrap gap-4 justify-between items-center w-full">
                              <div>
                                ...
                                <span className="text-lg font-black text-[#FF8B28] mt-1 block">
                                  {study.stats}
                                </span>
                              </div>
                              <div>
                  ...
                  return (
                    ...
                    >
                      {[study, nextStudy].map((item) => {
                        if (!item) return null;
                        return (
                          <motion.div
                            key={item._id}
                            variants={
                              index === 1 ? gridRightVariants : slideUpVariants
                            }
                            whileHover={{ y: -6 }}
                          ...
                          >
                            <div>
                              ...
                              <div className="p-6 md:p-8">
                                ...
                                <h4
                                  className="text-lg md:text-xl font-bold mb-4 uppercase tracking-wide leading-snug group-hover:text-[#E55503] transition-colors"
                ...
                <div className="space-y-6">
                  ...
                  <div className="border-t border-slate-100 pt-6">
                    ...
                    <p className="text-slate-600 text-sm leading-relaxed">
                      ...
                      {selectedCase.category.toLowerCase()} configured
                      specifically for localized load cycles, the project teams
                      maintained operating parameters. CPL&apos;s advanced
                      hydraulics and robust structural engineering mitigated
                      downtime.
                    </p>
                  </div>
                </div>
